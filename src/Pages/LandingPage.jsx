...
const LandingPage = () => {
  return (
    <>
      <div className="flex justify-center text-left px-24 pt-2">
        <div className=" w-[50%] pt-8 px-10">
          ...
          <p class="mt-10 font-semibold text-[16px] w-[60%] leading-tight">
            ...
            thumbnails from your portfolio such as screenshots or thumbnails
            from your.
          </p>
      ...
      <div className="m-auto mt-14 w-[85%]">
        <img src="https://preview.redd.it/food-delivery-app-design-work-in-progress-v0-s7tr2brz1oh91.png?auto=webp&s=92553cbeba3c07371f01f30c92ceab8573642013" alt="error"/>
      </div>
    </>
  );
};
